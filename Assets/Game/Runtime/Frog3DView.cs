...
namespace FrogCart.Runtime
{
    ...
    public sealed class Frog3DView : MonoBehaviour, IFrogView
    {
        ...
        /// <summary>
        /// Сколько секунд занимает доворот к цели и обратно.
        ///
        /// Было 0.15. На шаре с глазами такой поворот читался акцентом, а у фигуры
        /// с лапами дёргается всё тело — и дёргается часто, укус идёт раз в 0.67 с.
        /// </summary>
